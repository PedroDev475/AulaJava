...
public class DesafioAULA8 {


    public static class AULA7DESAFIO2 {


        static String[][] matrizCadastro = {null};
        static Scanner scanner = new Scanner(System.in);
        static String[] cabecalho = {"ID", "Nome", "Telefone", "Email"};
        static File bancoDeDados = new File("C:\\Users\\Aluno\\IdeaProjects\\AulaJava\\src\\DesafioAULA8.java");
    ...
    static void carregarDadosDoArquivo() throws IOException {
